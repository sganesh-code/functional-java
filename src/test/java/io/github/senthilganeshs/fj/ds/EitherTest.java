...
public class EitherTest {
    ...
    @Test
    public void testEitherFoldl() {
        Assert.assertEquals(Either.right(10).foldl(0, Integer::sum), Integer.valueOf(10));
        Assert.assertEquals(Either.left("error").foldl(0, (acc, i) -> acc + 1), Integer.valueOf(0));
    }
}
